...
<html lang="en">
<head>
        <title> Assignments/Projects | Marks </title>
	...
	<div class="container-fluid">
		<div class="row " style=" margin:2px;">   
			...
			<table id="list">
				<tbody>
			    <tr>
			        <td id="qpapers-button" > <a href="assg_proj.php">Question Paper</a> </td>
			    </tr>
			    <tr>
...
<script>
document.getElementById("marksheet-button").className+= " anotherClass";
</script>
		...
		<form method="post" enctype="multipart/form-data">
		    <h1>Assignment/project Marks Sheet<span>Select Marks Sheet to upload </span></h1>
		...
		<div name="all-references">
			<table style="padding:10px;">
				...
				<?php	
$sql="SELECT * FROM DOCUMENTS WHERE course_id='$course_id' and doc_type='assgn_proj_marks'";
$result = mysqli_query($conn,$sql);
if(mysqli_num_rows($result) > 0)
{
...
else
{
	echo 'No references uploaded';
		...
		$qry="INSERT INTO DOCUMENTS (faculty_id,course_id,doc_type,doc_name,doc_path,description,year,semester) VALUES ('$user','$course_id','assgn_proj_marks','$filename','$target_file','$description',$year,$sem)";
