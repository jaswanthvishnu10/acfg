...
<html lang="en">
<head>
        <title> Test 2 | Marks Sheet</title>
...
document.getElementById("marksheet-button").className+= " anotherClass1";
		...
		<form method="post" enctype="multipart/form-data">
		    <h1>T2 Marks Sheet<span>Select Marks Sheet to upload </span></h1>
		...
		<div name="all-references">
			<table style="padding:10px;">
				...
				<?php	
$sql="SELECT * FROM DOCUMENTS WHERE course_id='$course_id' and doc_type='t2_markssheet'";
$result = mysqli_query($conn,$sql);
if(mysqli_num_rows($result) > 0)
{
...
else
{
	echo 'No references uploaded';
		...
		header("Refresh:0"); //refresh_here1
		...
		$qry="INSERT INTO DOCUMENTS (faculty_id,course_id,doc_type,doc_name,doc_path,description,year,semester) VALUES ('$user','$course_id','t2_markssheet','$filename','$target_file','$description',$year,$sem)";
