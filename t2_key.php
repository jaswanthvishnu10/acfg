...
document.getElementById("keysheet-button").className+= " anotherClass1";
		...
		<div class="form-style-10">
		<form method="post" enctype="multipart/form-data">
		    <h1>T2 Key Sheet<span>Select Key Sheet to upload </span></h1>
		...
		<div name="all-references">
			<table style="padding:10px;">
				...
				<?php	
$sql="SELECT * FROM DOCUMENTS WHERE course_id='$course_id' and doc_type='t2_keysheet'";
$result = mysqli_query($conn,$sql);
if(mysqli_num_rows($result) > 0)
{
...
else
{
	echo 'No Keysheet uploaded';
		...
		$qry="INSERT INTO DOCUMENTS (faculty_id,course_id,doc_type,doc_name,doc_path,description,year,semester) VALUES ('$user','$course_id','t2_keysheet','$filename','$target_file','$description',$year,$sem)";
