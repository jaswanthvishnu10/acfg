...
<script>
document.getElementById("qpapers-button").className+= " anotherClass";
</script>
		...
		<form method="post" enctype="multipart/form-data">
		    <h1>Assignment/project<span>Select Question Paper to upload </span></h1>
		...
		<div name="all-references">
			<table style="padding:10px;">
				...
				<?php	
$sql="SELECT * FROM DOCUMENTS WHERE course_id='$course_id' and doc_type='assgn'";
$result = mysqli_query($conn,$sql);
if(mysqli_num_rows($result) > 0)
{
...
else
{
	echo 'No Question Papers uploaded';
		...
		$qry="INSERT INTO DOCUMENTS (faculty_id,course_id,doc_type,doc_name,doc_path,description,year,semester) VALUES ('$user','$course_id','assgn','$filename','$target_file','$description',$year,$sem)";
